...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="color: white; margin: 20px 0 0 0; font-size: 24px;">⏰ Promemoria Rinnovo</h1>
        </div>
        ...
        <div class="footer">
            ...
            <p style="margin: 0; font-size: 12px;">Hai domande? Contattaci a velika.03@outlook.it</p>
        </div>
    </div>
</body>
</html>
