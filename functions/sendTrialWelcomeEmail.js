...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="color: white; margin: 20px 0 10px 0; font-size: 28px;">🎉 Benvenuto in MyWellness!</h1>
            <p style="color: #d4f1ed; margin: 0; font-size: 16px;">La tua prova gratuita di 3 giorni inizia ora</p>
        </div>
