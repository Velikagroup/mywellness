...
Deno.serve(async (req) => {
    ...
    try {
        ...
        const { cardData, orderBumpSelected, appliedCouponCode, billingInfo, phoneNumber, trafficSource } = body;
            ...
            if (isNewUser && tempPasswordToSend) {
                ...
                await base44.asServiceRole.integrations.Core.SendEmail({
                    ...
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                        <h1 style="color: #26847F; text-align: center;">Benvenuto in MyWellness!</h1>
                        ...
                        <p style="font-size: 14px; color: #666;">Se hai bisogno di aiuto, contattaci a <a href="mailto:velika.03@outlook.it" style="color: #26847F;">velika.03@outlook.it</a></p>
                        
                        <p style="font-size: 12px; color: #999; text-align: center; margin-top: 30px;">© 2025 MyWellness. Tutti i diritti riservati.</p>
                    </div>
                    `
                });
                ...
                await base44.asServiceRole.integrations.Core.SendEmail({
                    ...
                    body: `
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                        <h1 style="color: #26847F; text-align: center;">Il Tuo Piano Premium è Attivo!</h1>
