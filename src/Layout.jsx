    ...
    <div className="min-h-screen animated-gradient-bg">
      ...
      {showActionMenu && (
        <>
          ...
          />
          <div className="fixed bottom-48 left-1/2 z-50 action-menu-drawer" style={{ transform: 'translateX(-50%)' }}>
      ...
      >
        {showActionMenu ? (
          <XIcon className="w-7 h-7" strokeWidth={3} style={{ transition: 'transform 0.3s ease-out', transform: 'rotate(90deg)' }} />
        ) : (
          <Plus className="w-7 h-7" strokeWidth={3} style={{ transition: 'transform 0.3s ease-out' }} />
        )}
      </button>
    </div>
  );
