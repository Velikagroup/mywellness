    ...
    <div className="min-h-screen pb-20 overflow-x-hidden">
      ...
      <div className="fixed bottom-32 right-6 flex gap-3 z-50" style={{ maxWidth: 'calc(100vw - 48px)' }}>
        {openChats.map((chat, index) => (
          ...
          onOpenTranslateDialog={(ticketId) => {
            setTranslatingForTicket(ticketId);
      ...
      function ChatWindow({ chat, onClose, onMinimize, onSendMessage, onUpdateMessage, onCloseTicket, onReopenTicket, isSending, index, onImageClick, onOpenTranslateDialog }) {
            ...
            <div className="flex gap-3">
              <div className="flex-1 space-y-2">
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <Button
                    type="button"
                    onClick={() => onOpenTranslateDialog(chat.id)}
