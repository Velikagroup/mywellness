...
import BodyScanAnimatedPreview from "../components/home/BodyScanAnimatedPreview";
    ...
    <div className="min-h-screen animated-gradient-bg overflow-x-hidden">
      ...
      <section className="pt-32 pb-20 px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* iPhone 16 Pro Max con Body Scan Animated */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 px-2">
            <Button
              ...
              onClick={handleGetStarted}
              disabled={isLoading}
              className="w-full sm:w-auto bg-[var(--brand-primary)] hover:bg-[var(--brand-primary-hover)] text-white rounded-full px-8 py-3 text-base font-semibold shadow-xl hover:shadow-2xl transition-all h-auto flex items-center justify-center md:justify-start gap-3 relative">
              <div className="rounded-full bg-red-500 flex items-center justify-center flex-shrink-0 md:-ml-[20px] -ml-[110px] md:relative absolute" style={{ width: '60px', height: '60px', marginRight: '4px' }}>
