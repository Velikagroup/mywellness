      ...
      <AnimatePresence key={animationKey}>
        {showIntro && (
          <motion.div
            ...
            className="absolute inset-0 flex items-center justify-center z-50 bg-white px-4"
          >
            <h1 className="animated-gradient-text text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black">
      ...
      {showVideo && (
        ...
        >
          ...
          <button
            ...
            className="absolute bottom-8 right-8 bg-[#26847F] hover:bg-[#1f6b66] text-white rounded-full p-4 shadow-xl transition-all hover:scale-110 z-10"
          >
