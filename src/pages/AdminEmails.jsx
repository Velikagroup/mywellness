...
export default function AdminEmails() {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      const isMultilingualEmail = ['cart_checkout_abandoned', 'cart_abandoned_24h', 'cart_abandoned_72h', 
...
${JSON.stringify(editingContent, null, 2)}`,
        ...
        const isMultilingualNew = ['cart_checkout_abandoned', 'cart_abandoned_24h', 'cart_abandoned_72h',
                                     'base_welcome', 'pro_welcome', 'premium_welcome', 'standard_free_welcome', 'welcome',
                                     'landing_new_user', 'landing_existing_user', 'password_reset_confirmed',
                                     'plan_upgrade', 'plan_downgrade', 'cancellation_confirmation', 'quiz_completed_abandoned',
  ...
  const handleSendTestEmail = async () => {
    ...
    try {
      ...
      if (isCartAbandonedEmail) {
        ...
        // Generate goal achieved email HTML
        htmlBody = generateGoalAchievedTestEmail(template, variables, appUrl);
      } else {
...
<p style="margin: 5px 0; font-size: 11px;">EIN: 36-5141800 - velika.03@outlook.it - <a href="https://billing.stripe.com/p/login/6oU8wIbUs08heL0dI08k800" target="_blank" rel="noopener noreferrer" style="color: #999999; text-decoration: none;">Stripe Portal</a></p>
  ...
  // Generate goal achieved email HTML for testing
  const generateGoalAchievedTestEmail = (template, variables, appUrl) => {
    ...
    const headerSubtitle = template?.header_subtitle || 'Hai raggiunto il tuo peso obiettivo!';
                    ...
                    <tr>
                        <td class="content-cell">
                            <div style="text-align: center; margin-bottom: 30px;">
                                ...
                                <h2 style="color: #111827; margin: 10px 0; font-size: 32px; font-weight: bold;">${headerTitle}</h2>
                                <p style="color: #6b7280; font-size: 18px; margin: 10px 0;">${headerSubtitle}</p>
                            </div>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; margin-top: 20px; background-color: #fafafa;">
                    <tr>
                        <td align="center" style="padding: 20px; color: #999999; background-color: #fafafa;">
                            ...
                            <p style="margin: 5px 0; font-size: 11px;"><a href="https://billing.stripe.com/p/login/6oU8wIbUs08heL0dI08k800" target="_blank" rel="noopener noreferrer" style="color: #26847F; text-decoration: none; font-weight: 600;">Stripe Portal</a></p>
                        </td>
                    </tr>
                </table>
            </td>
          ...
          <TabsContent value="system" className="space-y-6">
            <Card className="water-glass-effect border-gray-200/30">
              <CardHeader>
                ...
                <div className="flex items-center gap-3">
                  {(selectedCategory === 'critical' || selectedCategory === 'abandonment' || selectedCategory === 'reporting' || selectedCategory === 'technical' || selectedCategory === 'engagement') && (
