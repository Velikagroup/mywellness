...
export default function AppDemoFlow() {
  ...
  return (
    <div className="relative w-full max-w-[280px] mx-auto">
      ...
      {/* Main demo container - ridotto a max-h-[420px] */}
      <div className="demo-container relative bg-white rounded-2xl shadow-xl overflow-hidden border-4 border-gray-800" style={{ aspectRatio: '9/16', maxHeight: '420px' }}>
      ...
      {/* Loop indicator removed to reduce height */}
    </div>
  );
}