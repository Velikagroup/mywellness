  ...
  return (
    <div className="w-full flex items-center justify-center px-4">
      <div className="relative" style={{ 
        ...
        height: isDesktop ? '500px' : '810px',
        minHeight: isDesktop ? '500px' : '810px',
        maxHeight: isDesktop ? '500px' : '810px',
        margin: '0 auto',
        maxWidth: '100%'
      }}>
        <style>{`
        ...
        <div className="relative w-full h-full" style={{ minHeight: isDesktop ? '500px' : '810px', maxHeight: isDesktop ? '500px' : '810px' }}>
          <div
            ...
            style={{
              ...
              height: isDesktop ? '100%' : '720px',
              minHeight: isDesktop ? '100%' : '720px',
              maxHeight: isDesktop ? '100%' : '720px',
            ...
            <AnimatePresence mode="wait">
              {step === 0 && (
                <motion.div
                  ...
                  style={{ height: isDesktop ? '100%' : '720px', minHeight: isDesktop ? '100%' : '720px', maxHeight: isDesktop ? '100%' : '720px' }}
                >
