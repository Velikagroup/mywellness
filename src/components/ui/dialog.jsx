...
const DialogContent = React.forwardRef(({ className, children, overlayStyle, overlayClassName, hideClose, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay style={overlayStyle} className={overlayClassName} />
