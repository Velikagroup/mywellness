...
const GOALS = [
  { id: 'eat_healthy', icon: '🍎', label: 'Comer y vivir más sano' },
  { id: 'increase_energy', icon: '☀️', label: 'Aumentar mi energía y estado de ánimo' },
  { id: 'stay_motivated', icon: '💪', label: 'Mantente motivado y constante' },
  { id: 'feel_better', icon: '🧘', label: 'Sentirme mejor con mi cuerpo' }
];
...
export default function GoalsStep({ data, onDataChange, onNext, translations, currentStep, totalSteps, onPrev }) {
  ...
  return (
    <div className="space-y-6 pt-20 w-full max-w-[416px] mx-auto px-4 md:px-0 min-h-[80vh] flex flex-col justify-start pb-28">
      ...
      />
      <QuizQuestionHeader
        title={t.quizGoalsTitle || "¿Qué te gustaría lograr?"}
