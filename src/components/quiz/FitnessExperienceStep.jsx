...
export default function FitnessExperienceStep({ data, onDataChange, nextStep }) {
  ...
  const EXPERIENCE_LEVELS = [
    { id: 'never', label: t('workouts.expNever'), description: t('workouts.expNeverDesc') },
    { id: 'occasionally', label: t('workouts.expOccasionally'), description: t('workouts.expOccasionallyDesc') },
    { id: 'regularly_1_2', label: t('workouts.expRegular1_2'), description: t('workouts.expRegular1_2Desc') },
    { id: 'regularly_3_plus', label: t('workouts.expRegular3Plus'), description: t('workouts.expRegular3PlusDesc') }
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('workouts.fitnessExpTitle')}</h2>
        <p className="text-gray-600">{t('workouts.fitnessExpSubtitle')}</p>
      </div>
