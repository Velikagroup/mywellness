...
export default function BirthdateStep({ data, onDataChange }) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Qual è la tua data di nascita?</h2>
        <p className="text-gray-600">Ci aiuta a calcolare il tuo metabolismo con precisione e a celebrare i tuoi traguardi</p>
      </div>
      ...
      <div className="max-w-md mx-auto">
        ...
        <p className="text-sm text-gray-500 mt-2 text-center">
          {data.age ? `Hai ${data.age} anni` : 'Devi avere almeno 18 anni'}
        </p>
      </div>
    </div>
  );
