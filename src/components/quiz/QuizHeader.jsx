  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-40 bg-white pt-6 pb-4">
      <div className="w-full max-w-[416px] mx-auto px-4 flex items-start gap-1.5">
        <button
          onClick={handleBack}
          className="flex-shrink-0 w-5 h-5 text-gray-600 hover:text-gray-900 transition-colors mt-12"
        >
          <ArrowLeft className="w-5 h-5" />
        </button>
        {typeof currentStep === 'number' && totalSteps && (
          <div className="flex-grow h-0.5 bg-gray-200 rounded-full overflow-hidden mt-12">
            <div 
