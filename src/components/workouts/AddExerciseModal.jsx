        ...
        response_json_schema: {
          ...
          properties: {
            ...
            form_tips: { 
              type: "array", 
              items: { type: "string" },
              description: `6-8 form tips in ${langNames[language] || 'Italian'}`
            },
            target_muscles: {
              type: "array",
              items: { type: "string" },
            ...
            muscle_groups: { 
              type: "array", 
              items: { type: "string" },
              description: `Muscle groups in ${langNames[language] || 'Italian'}`
            },
            ...
            intensity_tips: {
              type: "array",
              items: { type: "string" },
              description: `2-4 intensity tips in ${langNames[language] || 'Italian'}`
            }
          },
