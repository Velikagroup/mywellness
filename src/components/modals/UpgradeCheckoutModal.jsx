...
export default function UpgradeCheckoutModal({ isOpen, onClose, selectedPlan = 'base', selectedBillingPeriod = 'monthly' }) {
  ...
  useEffect(() => {
    ...
    const initModal = async () => {
      try {
        ...
        // The field is called "referred_by_affiliate_code" in the Quiz when saving
        const affiliateCode = currentUser.referred_by_affiliate_code || currentUser.referred_by;
        console.log('🔍 Checking affiliate code:', affiliateCode, 'Full user:', currentUser);
        if (affiliateCode) {
          console.log('✅ Affiliate discount applied for code:', affiliateCode);
          ...
          console.log('❌ No affiliate code found on user');
        }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="max-w-2xl max-h-[90vh] overflow-y-auto water-glass-effect z-[300]"
      ...
      >
        ...
        <div className="px-4 sm:px-8 pb-8 space-y-6">
          ...
          {/* Campi billing - identici a TrialSetup */}
          ...
          {/* Metodi di pagamento - identici a TrialSetup */}
          <div className="space-y-4 pt-4 border-t border-gray-200/50">
