...
export default function UpgradeCheckoutModal({ isOpen, onClose, selectedPlan = 'base', selectedBillingPeriod = 'monthly' }) {
  ...
  return (
    <>
      ...
      {isOpen && <div className="fixed inset-0 z-50 animated-gradient-backdrop" />}
      
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto water-glass-effect z-[60]">
          <style>{`
          .water-glass-effect {
